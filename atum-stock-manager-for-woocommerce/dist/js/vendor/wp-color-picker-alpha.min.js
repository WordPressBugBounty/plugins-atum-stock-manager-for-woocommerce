				...
				setTimeout(function() {
					...
					if ($that.hasClass("active")) {
						...
						jQuery.each(colorPickerPalette, function(index, val) {
							palette.clone().data("color", val).css("backgroundColor", val).appendTo(container).height(20);
						});
	...
	jQuery.widget("a8c.iris", jQuery.a8c.iris, {
		_create: function() {
			...
			if (typeof this.options.alpha !== "undefined" && this.options.alpha) {
				var self = this, _html = "<div class=\"iris-strip iris-slider iris-alpha-slider\"><div class=\"iris-slider-offset iris-slider-offset-alpha\"></div></div>", aContainer = jQuery(_html).appendTo(self.picker.find(".iris-picker-inner")), aSlider = aContainer.find(".iris-slider-offset-alpha"), controls = {
					aContainer,
					aSlider
				};
		...
		_addInputListeners: function(input) {
			var self = this, debounceTimeout = 100, callback, placeholder = jQuery("." + input.attr("name"));
			...
			resetCallback = function(event) {
				var color = new Color(input.val()), defaultColor = self._color.toString();
		...
		_addPalettes: function() {
			var container = jQuery("<div class=\"iris-palette-container\" />"), palette = jQuery("<a class=\"iris-palette\" tabindex=\"0\" />"), colors = colorPickerPalette;
