			...
			if (useAbsolutePositioning) {
				var makeRelative = function($container, alwaysWrap) {
					...
					if (!relativeToScrollContainer || alwaysWrap) {
						...
						$containerWrap = $container.data("floatThead-containerWrap") || $container.wrap($("<div>").addClass(opts.floatWrapperClass).css({
							"position": "relative",
							"clear": "both"
						})).parent();
			...
			*/
			...
			function changePositioning(isAbsolute) {
				if (useAbsolutePositioning != isAbsolute) {
					...
					$floatContainer.css({ position: useAbsolutePositioning ? "absolute" : "fixed" });
				}
			}
				...
				return function(eventType) {
					...
					if (locked && useAbsolutePositioning) {
						...
						if (windowTop > floatEnd + tableHeight + captionScrollOffset) {
							top = tableHeight - floatContainerHeight + captionScrollOffset + scrollingBottom;
			...
			*/
			...
			$table.data("floatThead-attached", {
				destroy: function() {
					...
					$window.off(ns);
					$window.off("fth-beforeprint fth-afterprint");
					if (matchMediaPrint) {
