...
(function($) {
	...
	var EasyTree = function(jQueryContext, options) {
		...
		function buildTree(nodes) {
			...
			$this.on("click.easytreeExpander", ".easytree-expander", nodes, toggleNodeEvt).on("dblclick.easytreeNode", ".easytree-icon, .easytree-title", nodes, toggleNodeEvt);
			var s7 = new Date();
			if (_settings.enableDnd) {
		...
		function convertHtmlToNode(element) {
			...
			// ATUM: Exclude the ui icon from the data atts once processed.
