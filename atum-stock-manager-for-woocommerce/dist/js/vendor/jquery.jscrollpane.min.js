	...
	$.fn.jScrollPane = function(settings) {
		...
		function JScrollPane(elem, s) {
			...
			function positionDragY(destY, animate) {
				...
				var isAtTop = tmpVerticalDragPosition === 0, isAtBottom = tmpVerticalDragPosition == dragMaxY, percentScrolled = destY / dragMaxY, destTop = -percentScrolled * (contentHeight - paneHeight);
				...
				if (animate) {
					jsp.animate(verticalDrag, "top", destY, _positionDragY, function() {
						elem.trigger("jsp-user-scroll-y", [
							-destTop,
							isAtTop,
							isAtBottom
						]);
			...
			function positionDragX(destX, animate) {
				...
				var isAtLeft = tmpHorizontalDragPosition === 0, isAtRight = tmpHorizontalDragPosition == dragMaxX, percentScrolled = destX / dragMaxX, destLeft = -percentScrolled * (contentWidth - paneWidth);
				if (animate === undefined) {
					animate = settings.animateScroll;
				}
				if (animate) {
					jsp.animate(horizontalDrag, "left", destX, _positionDragX, function() {
						elem.trigger("jsp-user-scroll-x", [
							-destLeft,
							isAtLeft,
							isAtRight
						]);
